...
if __name__ == '__main__':
    ...
    dico_patterns = { # Dimension et pattern dans un tuple
        ...
        "beacon2"  : ((12,12), [(4,6),(4,7),(5,6),(5,7),(6,4),(6,5),(7,4),(7,5)]),
        ...
        "floraison2" : ((15,15), [(7,6),(7,7),(7,8),(8,5),(8,5),(8,9),(9,6),(9,7),(9,8)]),
        "floraison3" : ((16,16), [(7,6),(7,7),(7,8),(8,5),(8,5),(8,9),(9,6),(9,7),(9,8)]),        
    ...
    if rank == 0:
        ...
        comm.send(grid, dest=1, tag=10)
    elif rank == 1:
        grid = comm.recv(source=0, tag=10)
        appli = App((resx,resy),grid)
       
    while(True):
        time.sleep(5) # A régler ou commenter pour vitesse maxi
        ...
        if rank == 0:
            ...
            print(f"Temps DESSIN prochaine generation : {t4-t3:2.2e} secondes")
